...
export default function FormatDocumentPage() {
     ...
     <Header/>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Document Format Converter</h2>
          <p className="text-gray-600">Transform your documents with AI-powered formatting</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-[calc(100vh-200px)]">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 flex flex-col">
            ...
            <div className="mb-6">
              ...
              >
                ...
                <p className="text-xs text-gray-500 mb-3">Supports: DOC, DOCX, PDF, TXT, MD</p>
                <button
                  type="button"
            ...
            {processing && (
              <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200" id="processing-status">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm font-semibold text-gray-700">AI Processing Status</span>
                ...
                <p className="text-xs text-gray-600">Document analysis and formatting in progress...</p>
              </div>
            )}
            ...
            >
              {processing ? (
                ...
                <><i className="fas fa-magic mr-2"></i>{showSuccess ? 'Start New Formatting' : 'Start AI Formatting'}</>
              )}
            </button>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 flex flex-col">
              ...
              <div className="bg-gray-50 rounded-xl h-full p-4 border-2 border-gray-200 overflow-y-auto min-h-[400px]">
                ...
                {!processing && !showSuccess && (
                  <div className="flex flex-col items-center justify-center h-full text-gray-400">
                    ...
                    <p className="text-sm text-center">Upload a document and start formatting to see the preview</p>
                  </div>
                )}
                ...
                {(processing || showSuccess) && (
                  <div className="bg-white p-6 rounded-lg shadow-sm min-h-full">
                    <div className="text-center mb-6">
                      <h1 className="text-xl font-bold mb-2">Machine Learning Applications in Healthcare</h1>
                      <p className="text-sm text-gray-600 mb-1">John Doe, Jane Smith</p>
            ...
            <div className="mt-auto">
              ...
              >
                {downloaded ? (
                  <><i className="fas fa-check mr-2"></i>Downloaded!</>
                ) : (
      ...
      <Footer />
      {/* Custom Styles */}
      <style>{`.format-btn.active { border-color: #6366f1 !important; background-color: #eef2ff !important; }`}</style>
    </div>
  );
}
